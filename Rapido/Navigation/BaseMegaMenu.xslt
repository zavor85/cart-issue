  ...
  <msxsl:script language="C#" implements-prefix="user">
    ...
    public string GenerateHeadingImageUrl(string image)
      ...
      string imageUrl = image;
          ...
          imageUrl = "/Admin/Public/GetImage.ashx?width=120&height=100&amp;crop=5&DoNotUpscale=true&FillCanvas=true&Compression=75&image=" + @image;
      } else {
    ...
    <xsl:if test="@RelativeLevel>=/NavigationTree/Settings/LayoutNavigationSettings/@ecomStartLevel">
        <xsl:choose>
            <xsl:when test="$type = 'list'">
                <li>
                 <xsl:if test="position() &lt; /NavigationTree/Settings/LayoutNavigationSettings/@maxItems or @RelativeLevel=/NavigationTree/Settings/LayoutNavigationSettings/@ecomStartLevel">
                  <xsl:attribute name="class">
                            ...
                            <div class="grid__col-12">
                              <a>
                                  <xsl:attribute name="href">
                                   ...
                                   <xsl:attribute name="class">
                                    <xsl:text disable-output-escaping="yes">btn btn--condensed btn--primary u-no-margin dw-mod link-to-category</xsl:text>
                                  </xsl:attribute>
                                  Se flere mærker 
                  ...
                  <xsl:if test="position() = /NavigationTree/Settings/LayoutNavigationSettings/@maxItems and @RelativeLevel!=/NavigationTree/Settings/LayoutNavigationSettings/@ecomStartLevel">
               
                        <a>
                          <xsl:attribute name="class">
                            <xsl:text disable-output-escaping="yes"> mega-menu__link dw-mod show-all fa-arrow-to-right</xsl:text>
                          </xsl:attribute>
                          <xsl:attribute name="href">
                            <xsl:value-of select="../@FriendlyHref" disable-output-escaping="yes"/>
                          </xsl:attribute>
...
<xsl:if test="@Allowclick='True'">
            <div>
                <xsl:attribute name="parentgrpname">
                    <xsl:value-of select="../@MenuText" disable-output-escaping="yes"/>
                </xsl:attribute>
              <xsl:attribute name="class">
                <xsl:if test="/NavigationTree/Settings/LayoutNavigationSettings/@promotionImage=''">
              ...
              <div class="mega-menu__list-wrap dw-mod">
                <xsl:if test="@Allowclick='True'">
                  <div>
                    ...
                    <xsl:choose>                        
                      <xsl:when test="@SmallImage != '' and /NavigationTree/Settings/LayoutNavigationSettings/@showOnlyHeaders='false'">
